...
class RecipesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        secondary_list = response.css("li.wprm-recipe-instruction").css("div.wprm-recipe-instruction-text").css('span::text').getall()
        instruction = response.css('div.wprm-recipe-instruction-text::text').getall() + secondary_list
        #
